...
from rag_pipelines.baml_client.types import MetaMedQAAnswer
from rag_pipelines.metamedqa.metamedqa_rag import (
...
class TestMetaMedQARAG:
    """Test the MetaMedQA RAG module components."""
    ...
    async def test_answer_generation_node(self):
        ...
        `GenerateMetaMedQAAnswer` function and processes the structured output.
        """
        mock_baml_response = MetaMedQAAnswer(
            answer="This is the mocked BAML answer.",
            chain_of_thought="mocked reasoning",
        )

        with patch(
            "rag_pipelines.metamedqa.metamedqa_rag.b.GenerateMetaMedQAAnswer",
    ...
    @pytest.mark.asyncio
    @patch("rag_pipelines.metamedqa.metamedqa_rag.b.GenerateMetaMedQAAnswer")
    @patch("rag_pipelines.metamedqa.metamedqa_rag.evaluate")
    @patch("rag_pipelines.metamedqa.metamedqa_rag.load_dataset")
    @patch("rag_pipelines.metamedqa.metamedqa_rag.HuggingFaceEmbeddings")
    @patch("rag_pipelines.metamedqa.metamedqa_rag.Milvus")
    @patch("rag_pipelines.metamedqa.metamedqa_rag.ContextualReranker")
    @patch("rag_pipelines.metamedqa.metamedqa_rag.MetadataEnricher")
    @patch("rag_pipelines.metamedqa.metamedqa_rag.ContextualRecallMetric")
    @patch("rag_pipelines.metamedqa.metamedqa_rag.ContextualPrecisionMetric")
    @patch("rag_pipelines.metamedqa.metamedqa_rag.ContextualRelevancyMetric")
    @patch("rag_pipelines.metamedqa.metamedqa_rag.AnswerRelevancyMetric")
    @patch("rag_pipelines.metamedqa.metamedqa_rag.FaithfulnessMetric")
    @patch("rag_pipelines.metamedqa.metamedqa_rag.load_dotenv")
    ...
    async def test_main_with_mocked_dependencies(
        ...
        mock_generate_answer.return_value = MetaMedQAAnswer(
            answer="Test answer", chain_of_thought="Test reasoning"
        )
