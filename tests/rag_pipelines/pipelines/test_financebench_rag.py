...
from rag_pipelines.baml_client.types import FinanceBenchAnswer
...
class TestFinanceBenchRAG:
    ...
    async def test_answer_generation_node(self):
        ...
        `GenerateFinanceBenchAnswer` function and processes the structured output.
        """
        mock_baml_response = FinanceBenchAnswer(
            summary="This is the mocked BAML answer.",
            chain_of_thought="mocked reasoning",
        )

        with patch(
            "rag_pipelines.financebench.financebench_rag.b.GenerateFinanceBenchAnswer",
    ...
    @pytest.mark.asyncio
    @patch("rag_pipelines.financebench.financebench_rag.b.GenerateFinanceBenchAnswer")
    ...
    @patch("rag_pipelines.financebench.financebench_rag.MetadataEnricher")
    ...
    async def test_main_with_mocked_dependencies(
        ...
        mock_contextual_relevancy,
        mock_contextual_precision,
        mock_contextual_recall,
        ...
        mock_generate_answer.return_value = FinanceBenchAnswer(
