"""Test the Earnings Calls RAG module."""
...
from rag_pipelines.baml_client.types import Answer
...
class TestEarningsCallsRAG:
    """Test the Earnings Calls RAG module components."""
    ...
    async def test_answer_generation_node(self):
        ...
        This test ensures that the node correctly calls the BAML `GenerateAnswer`
        function and processes the structured output.
        """
        mock_baml_response = Answer(
            summary="This is the mocked BAML answer.",
            chain_of_thought="mocked reasoning",
        )

        with patch(
            "rag_pipelines.earnings_calls.earnings_calls_rag.b.GenerateAnswer",
    ...
    @patch("rag_pipelines.earnings_calls.earnings_calls_rag.MetadataEnricher")
