"""Test the earnings_calls RAG module."""
...
from rag_pipelines.earnings_calls.earnings_calls_rag import (
...
class TestEarningsCallsRAG:
    """Test the earnings_calls RAG module components."""
    ...
    def test_evaluation_node(self):
        ...
        with patch(
            "rag_pipelines.earnings_calls.earnings_calls_rag.evaluate",
    ...
    @patch("rag_pipelines.earnings_calls.earnings_calls_rag.ChatGroq")
    @patch("rag_pipelines.earnings_calls.earnings_calls_rag.HuggingFaceEmbeddings")
    @patch("rag_pipelines.earnings_calls.earnings_calls_rag.Milvus")
    @patch("rag_pipelines.earnings_calls.earnings_calls_rag.ContextualReranker")
    @patch("rag_pipelines.earnings_calls.earnings_calls_rag.MetadataExtractor")
    @patch("rag_pipelines.earnings_calls.earnings_calls_rag.ContextualRecallMetric")
    @patch("rag_pipelines.earnings_calls.earnings_calls_rag.ContextualPrecisionMetric")
    @patch("rag_pipelines.earnings_calls.earnings_calls_rag.ContextualRelevancyMetric")
    @patch("rag_pipelines.earnings_calls.earnings_calls_rag.AnswerRelevancyMetric")
    @patch("rag_pipelines.earnings_calls.earnings_calls_rag.FaithfulnessMetric")
    @patch("rag_pipelines.earnings_calls.earnings_calls_rag.load_dotenv")
