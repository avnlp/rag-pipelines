...
class TestMetamedqaIndexing:
    ...
    @patch("rag_pipelines.metamedqa.metamedqa_indexing.ChatGroq")
    ...
    @patch("rag_pipelines.metamedqa.metamedqa_indexing.MetadataExtractor")
    ...
    def test_main_with_mocked_dependencies(
        ...
        # Mock dataset
        # MetaMedQA structure expects 'context' field with nested 'contexts'
