...
class TestHealthbenchRAG:
    ...
    @patch("rag_pipelines.healthbench.healthbench_rag.ChatGroq")
    ...
    @patch("rag_pipelines.healthbench.healthbench_rag.MetadataExtractor")
    ...
    def test_main_with_mocked_dependencies(
        ...
        mock_g_eval_instance.__name__ = "GEval"
        ...
        # Note: We don't check specific open calls because load_dotenv()
        # also opens .netrc files
