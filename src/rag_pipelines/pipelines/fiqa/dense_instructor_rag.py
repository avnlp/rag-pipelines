...
dense_pipeline.connect("embedding_retriever.documents", "prompt_builder.documents")
dense_pipeline.connect("prompt_builder", "llm")
dense_pipeline.connect("llm.replies", "answer_builder.replies")
dense_pipeline.connect("embedding_retriever.documents", "answer_builder.documents")
