...
hybrid_pipeline.connect("similarity_ranker.documents", "prompt_builder.documents")
hybrid_pipeline.connect("prompt_builder", "llm")
hybrid_pipeline.connect("llm.replies", "answer_builder.replies")
hybrid_pipeline.connect("similarity_ranker.documents", "answer_builder.documents")
