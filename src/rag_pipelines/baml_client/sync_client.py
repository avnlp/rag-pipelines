...
class BamlSyncClient:
    ...
    def ExtractMetadata(self, text: str,
        ...
        if 'on_tick' in baml_options:
            ...
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="ExtractMetadata", args={
                "text": text,
            })
    ...
    def GenerateAnswer(self, context: str,question: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="GenerateAnswer", args={
    ...
    def GenerateHealthBenchAnswer(self, context: str,question: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="GenerateHealthBenchAnswer", args={
                "context": context,"question": question,
            })
    ...
    def GenerateMetaMedQAAnswer(self, context: str,question: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="GenerateMetaMedQAAnswer", args={
                "context": context,"question": question,
            })
    ...
    def GeneratePubMedAnswer(self, context: str,question: str,
        ...
        if 'on_tick' in baml_options:
            ...
            # Original non-streaming code
            result = self.__options.merge_options(baml_options).call_function_sync(function_name="GeneratePubMedAnswer", args={
                "context": context,"question": question,
            })
...
class BamlStreamClient:
    ...
    def ExtractMetadata(self, text: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.DynamicMetadata, types.DynamicMetadata]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="ExtractMetadata", args={
            "text": text,
        })
        return baml_py.BamlSyncStream[stream_types.DynamicMetadata, types.DynamicMetadata](
          result,
    ...
    def GenerateAnswer(self, context: str,question: str,
        ...
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="GenerateAnswer", args={
            "context": context,"question": question,
        })
    ...
    def GenerateHealthBenchAnswer(self, context: str,question: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.HealthBenchAnswer, types.HealthBenchAnswer]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="GenerateHealthBenchAnswer", args={
            "context": context,"question": question,
        })
        return baml_py.BamlSyncStream[stream_types.HealthBenchAnswer, types.HealthBenchAnswer](
          result,
    ...
    def GenerateMetaMedQAAnswer(self, context: str,question: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.MetaMedQAAnswer, types.MetaMedQAAnswer]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="GenerateMetaMedQAAnswer", args={
            "context": context,"question": question,
        })
        return baml_py.BamlSyncStream[stream_types.MetaMedQAAnswer, types.MetaMedQAAnswer](
          result,
    ...
    def GeneratePubMedAnswer(self, context: str,question: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.PubMedAnswer, types.PubMedAnswer]:
        ctx, result = self.__options.merge_options(baml_options).create_sync_stream(function_name="GeneratePubMedAnswer", args={
            "context": context,"question": question,
        })
        return baml_py.BamlSyncStream[stream_types.PubMedAnswer, types.PubMedAnswer](
          result,
...
class BamlHttpRequestClient:
    ...
    def ExtractMetadata(self, text: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="ExtractMetadata", args={
            "text": text,
        }, mode="request")
        return result
    def GenerateAnswer(self, context: str,question: str,
    ...
    def GenerateHealthBenchAnswer(self, context: str,question: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="GenerateHealthBenchAnswer", args={
            "context": context,"question": question,
        }, mode="request")
        return result
    def GenerateMedCaseReasoningAnswer(self, context: str,question: str,
    ...
    def GenerateMetaMedQAAnswer(self, context: str,question: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="GenerateMetaMedQAAnswer", args={
            "context": context,"question": question,
        }, mode="request")
        return result
    def GeneratePubMedAnswer(self, context: str,question: str,
        ...
        result = self.__options.merge_options(baml_options).create_http_request_sync(function_name="GeneratePubMedAnswer", args={
            "context": context,"question": question,
        }, mode="request")
        return result
